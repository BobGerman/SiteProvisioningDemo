...
Write-Host "Provisioning metadata widget to $Url"
Connect-PnPOnline -Url $Url -Credentials $Credentials
New-PnPList -Title "MetadataWP" -Template DocumentLibrary -Url "metadataWP"

# Define source and destinations for the copy, as well as SharePoint app packaging files
# that we don't need
$localAppPath = (Get-Item -Path ..\TypeScriptWidgets\metadataWidget).FullName
$spAppPath = "/metadataWP"
$filesToSkip = '.ts'
